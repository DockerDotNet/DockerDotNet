...
namespace DockerDotNet.Shared.Models
{
    ...
    public partial class ConfigReference
    {
        ...
        /// </summary>
        /// <value>The name of the config-only network that provides the network&#39;s configuration. The specified network must be an existing config-only network. Only network names are allowed, not network IDs. </value>
        /* <example>config_only_network_01</example> */
